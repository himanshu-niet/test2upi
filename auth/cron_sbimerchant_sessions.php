...
$merchant = rechpay_fetch_all(rechpay_query("SELECT * FROM `merchant` WHERE `merchant_name`='SBI Merchant' AND `status`='Active' AND (NOW() - INTERVAL 300 MINUTE)>=merchant_timestamp ORDER BY merchant_timestamp ASC LIMIT 20"));
